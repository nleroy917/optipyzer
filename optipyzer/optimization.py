...
def codon_optimize(seq: str, organism_list: list[str], weights: dict = None, seq_type: str = None):
	...
	best_expression_sd = optimize_multitable_sd(
		average_table, 
		peptide_seq, 
		usage_data, 
		rca_xyz, 
	...
	best_expression_ad = optimize_multitable_ad(
		average_table, 
		peptide_seq, 
		usage_data, 
		rca_xyz, 
