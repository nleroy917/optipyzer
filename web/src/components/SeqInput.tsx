...
const SeqInput: FC<Props> = (props) => {
  ...
  // message
  const [seqValidationMessage, setSeqValidationMessage] = useState<null | string>(null)

  // styling
  const validStyling = "w-full p-2 mb-2 text-sm text-gray-600 border border-black rounded-lg shadow-md md:w-3/4"
  const invalidStyling = "w-full p-2 mb-2 text-sm text-red-600 border border-red-600 rounded-lg shadow-md md:w-3/4 focus:border-red-600"
