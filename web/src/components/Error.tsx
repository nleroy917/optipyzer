                    ...
                    <div className="p-4 mx-6 bg-blue-200 border-2 border-blue-500 rounded-md shadow-lg">
                        ...
                        <div className="flex flex-row justify-center mt-4 md:justify-start">
                          ...
                          <Link href="/optimize" passHref>
                            <button onClick={() => setError(null)} className="px-6 py-2 mx-1 font-bold text-white transition-all bg-black border-2 border-black rounded-lg hover:bg-transparent hover:text-black">
                                Back
                            </button>
                          </Link>                            
                        </div>
