...
exports.buildSitemapXml = (fields) => {
    const content = fields
        ...
        for (const key of Object.keys(fieldData)) {
            if (fieldData[key]) {
                if (key !== 'alternateRefs') {
                    ...
                    field.push(exports.buildAlternateRefsXml(fieldData.alternateRefs));
                }
            }
        }
        ...
        .join('');
    return withXMLTemplate_1.withXMLTemplate(content);
};
exports.buildAlternateRefsXml = (alternateRefs = []) => {
