...
export const createUrlSet = (config, manifest) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (config.additionalPaths) {
        const additions = (_b = (yield config.additionalPaths(Object.assign(Object.assign({}, config), { transform: (_a = config.transform) !== null && _a !== void 0 ? _a : transformSitemap })))) !== null && _b !== void 0 ? _b : [];
